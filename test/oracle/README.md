...
**Presets:** `default`, `basic`, `core`, `rebase-heavy`, `merge-heavy`, `am-heavy`, `cherry-pick-heavy`, `no-rename-show`, `no-show`, `wide-files`, `chaos`, `chaos-heavy`, `clone-cannoli`, `clone-core`, `fuzz-light`, `fuzz-heavy`, `chaos-fuzz`, `gitignore`, `kitchen`, `stress`, `remote`, `remote-core`, `remote-heavy`
